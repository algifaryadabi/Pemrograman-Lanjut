...
public class MainLibrary {
    public static void main(String[] args) {
        ...
        Perpustakaan add = new Perpustakaan();
        ...
        while (true) {
            ...
            if (code == 1) {
                ...
                System.out.println("Terdapat 35 jumlah buku yang ada di Perpustakaan ini");
                ...
                System.out.println();
                System.out.println("Angka tidak tersedia, dan buku tidak ada ( Error )");
                System.out.println();
            }
        }
        scan.close();
